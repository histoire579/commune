  ...
  <section class="wrapper">
    ...
    <div class="row mt">
        <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 mb"><a style="float: left;margin-left: 100px" href="/administration/service" type="button"  class="btn btn-default"><i class="fa fa-arrow-circle-o-left" style="color: #08367A" aria-hidden="true"></i> Retourner à la liste</a></div>
         ...
         @include('admin.page.message')
          <div class="form-panel">
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.service')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="mesure" name="mesure" minlength="2" type="text"  />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="qualite" class="control-label col-lg-3">Qualité du serice</label>
                      <div class="col-lg-9">
                        <input class=" form-control" id="qualite" name="qualite" minlength="2" type="text"  />
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="amelioration" name="amelioration" minlength="2" type="text"  />
                      </div>
                    </div>

    ...
    <div class="container pt-5 pb-6 pt-md-7 pb-md-8 text-center">
      <div class="row">
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <h2 class="display-5 mb-3">Services sociaux de base {{$quartier->nom}}</h2>
...
<section class="wrapper bg-light" id="elts">
    @include('front.quartier.service.content')
</section>
@endsection
@section('extra-js')
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    function getPage(page) {
        ...
        $.ajax({
            type:'get',
            url:"{{ route('services.quartier.search') }}" + "?page=" +page,
    ...
    $(document).on('click','#view',function(){
        ...
        $.ajax({
            type:'get',
            url:"{{ route('services.quartier.search') }}",
            data:{'qua_id':quaId, 'cat_id':typeId},
            success:function(data){
                console.log('success');
                console.log(data);

    ...
    <div class="container pt-5 pb-6 pt-md-7 pb-md-8 text-center">
      <div class="row">
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <h2 class="display-5 mb-3">Personnes handicapées {{$commune->nom}}</h2>
...
<section class="wrapper bg-light" id="elts">
    @include('front.commune.handicap.content')
</section>
@endsection
@section('extra-js')
...
$(document).ready(function(){
    ...
    function getPage(page) {
        ...
        $.ajax({
            type:'get',
            url:"{{ route('handicap.commune.search') }}" + "?page=" +page,
    ...
    $(document).on('click','#view',function(){
        ...
        $.ajax({
            type:'get',
            url:"{{ route('handicap.commune.search') }}",
            data:{'com_id':comId, 'qua_id':quaId, 'type_id':typeId, 'sexe':sexeId, 'age':age, 'seuil':seuilId, 'groupe':groupeId},
            success:function(data){
                console.log('success');
                console.log(data);

    ...
    <div class="row mt">
        <div class="col-lg-12">
          ...
          <div class="form-panel">
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.acteur.edit',$acteur->id)}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="nom" name="nom" minlength="2" value="{{$acteur->nom}}" type="text" required />
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="localisation" name="localisation" value="{{$acteur->localisation}}" minlength="2" type="text"  />
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="contacts" name="contact" value="{{$acteur->contact}}" minlength="2" type="text"  />
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="capacite" name="capacite" minlength="2" value="{{$acteur->capacite}}" type="text"  />
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <input class=" form-control" id="commodite" name="commodite" minlength="2" value="{{$acteur->commodite}}" type="text"  />
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                        <textarea class="form-control" name="autre" id="autre" placeholder="Vos détails" rows="5" data-rule="required" data-msg="Vos détails">{{$acteur->autre}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-lg-10 col-sm-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        ...
                        @else
                        <img src="{{asset('/storage/imgs/'.$acteur->image)}}" alt="" />
                        @endif
                      </div>
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="/administration/acteur" type="button" class="btn btn-danger">Annuler</a>
                  </div>
                </div>
              </form>
            </div>

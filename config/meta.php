...
return [
    ...
    */
    ...
    |
    */
	'description' => 'Base de données des personnes vivant avec un HANDICAP, des services sociaux de base et des acteurs du Mfoundi',
    ...
    */
    ...
    |
    */
	'keywords' => 'Base de données des personnes vivant avec un HANDICAP,HANDICAP,services sociaux de base,acteurs,Mfoundi,PvH',
